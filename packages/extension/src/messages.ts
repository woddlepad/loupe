...
export type LoupeMessage =
  ...
  | { type: "group-run"; slug: string; action: string; model?: string; speed?: string }
  | { type: "resolve-group"; slug: string }
  | { type: "annotation-run"; id: string; action: string; model?: string; speed?: string }
  | { type: "resolve-target"; target: AnnotationTarget }
  | { type: "references" }
  | { type: "reference-image"; id: string }
  | { type: "file-data-url"; dir: string; file: string }
