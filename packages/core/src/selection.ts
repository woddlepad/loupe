...
function containEvents(host: HTMLElement): void {
  ...
  // key master; pointer/click bubbling is stopped here after Loupe controls
  // receive the events they need for focus and activation.
  const stop = (e: Event) => e.stopPropagation();
  for (const type of ["input", "beforeinput", "pointerup", "mouseup", "click", "dblclick", "auxclick", "contextmenu"]) {
